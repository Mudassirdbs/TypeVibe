...
export const metadata: Metadata = {
  title: {
    default:
      "Typevibe - Free Typing Test with Mechanical Keyboard Sounds | WPM & Accuracy",
    template: "%s | Typevibe",
  },
    ...
    images: [
      {
        ...
        width: 1500,
        height: 1016,
        alt: "Typevibe - typing test with mechanical keyboard sounds, on-screen keyboard, and real-time WPM tracking",
      },
    ],
  },
  twitter: {
    card: "summary_large_image",
    title: "Typevibe - Typing Test with Mechanical Keyboard Sounds",
    description:
