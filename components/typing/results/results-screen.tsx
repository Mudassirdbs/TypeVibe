...
export function ResultsScreen({
  ...
  return (
    <div className="flex w-full flex-col gap-3.5 md:mx-auto md:max-w-5xl md:gap-4.5">
      {wpm >= 70 && (
        <Confetti
      ...
      <div className="flex items-end justify-center gap-5 pt-1 sm:gap-8 md:gap-10">
        {/* WPM */}
        <div className="flex flex-col items-center gap-1">
          ...
          >
            <AnimatedNumber
              className="font-bold font-mono text-5xl text-primary leading-none sm:text-6xl md:text-8xl"
              value={wpm}
            />
          </motion.div>
        ...
        <div className="flex flex-col items-center gap-1">
          ...
          >
            <span className="font-bold font-mono text-5xl text-foreground leading-none sm:text-6xl md:text-8xl">
              <AnimatedNumber value={accuracy} />
              <span className="text-3xl text-muted-foreground sm:text-4xl md:text-6xl">
                %
              </span>
            </span>
          </motion.div>
      ...
      {/* ── Personal best badge — bounces in ── */}
      {pb?.isNewPb && (
        <motion.div
      ...
      <motion.div
        ...
        className="h-[140px] w-full md:h-[165px]"
      ...
      <div className="flex flex-wrap items-center justify-center gap-x-4 gap-y-2 pb-2">
        {[
          ...
          <ShareScoreCardButton key="share" stats={stats} />,
